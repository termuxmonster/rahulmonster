...
try:
	while True:
		choix = input("\n x9t-information("+Fore.BLUE + "~" + Fore.RESET + ")$ ")
		...
		if choix.lower() == 'h':
			...
			while True:
				...
				choix = input("\n x9t-information("+Fore.BLUE + "Profiler" + Fore.RESET + ")$ ")
				...
				if choix.lower() == 'h':
					...
					sys.exit("\n"+information+" from termux monster bye ! :)")
				elif choix.lower() == "1":
					if pr.count >= 1:
						while True: 
			...
			print(lookupOption)
			while True:
				lookup = input("\n x9t-information("+Fore.BLUE+"Lookup"+Fore.BLUE + "" + Fore.RESET + ")$ ")
				if lookup == 'h':
					print(helpLookup)
				elif lookup.lower() == '1':
			...
			while True:
				se = input("\n x9t-information("+Fore.BLUE+"OtherTool"+Fore.BLUE + "" + Fore.RESET + ")$ ")
				if se == 'h':
					print(helpOtherTool)
				elif se == "1":
					hashdecrypt()
			...
			while True:
				newCode = input("\n x9t-information("+Fore.BLUE+"Country"+Fore.BLUE + "" + Fore.RESET + ")$ ")
				if newCode == '1':
	...
	sys.exit("\n"+information+" from termux monster bye bye!:)")
